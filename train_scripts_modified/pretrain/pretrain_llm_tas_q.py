"""
LLM-Enhanced TAS-Query Training Script

This script integrates LLM-based hard negative classification into TAS-Query pretraining
...
# Configuration
ENABLE_LLM = True  # Set to False for baseline TAS-Query training
...
train_data = enhancer.enhance_training_data(train_data, method='TAS-Query')
...
# TAS-Query specific settings
model_args.ance_training = False

# Setup model configuration paths using common LLM integration
base_output_dir = "../../trained_models/pretrained/TAS-Q-msmarco"
base_wandb_name = "TAS-Q-msmarco"
...
if __name__ == "__main__":
    ...
    print(f"🚀 Starting {'LLM-Enhanced' if enhancer.llm_available and ENABLE_LLM else 'Baseline'} TAS-Query Training")
