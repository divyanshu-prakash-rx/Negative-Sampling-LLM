"""
LLM-Enhanced DPR-BM25 Training Script

This script integrates LLM-based hard negative classification into DPR-BM25 pretraining
...
# Configuration
ENABLE_LLM = True  # Set to False for baseline DPR-BM25 training
...
train_data = enhancer.enhance_training_data(train_data, method='DPR-BM25')
...
# Disabling ANCE training (DPR-BM25 specific)
model_args.ance_training = False

# Setup model configuration paths using common LLM integration
base_output_dir = "../../trained_models/pretrained/DPR-BM-msmarco"
base_wandb_name = "DPR-BM-msmarco"
...
if __name__ == "__main__":
    ...
    print(f"🚀 Starting {'LLM-Enhanced' if enhancer.llm_available and ENABLE_LLM else 'Baseline'} DPR-BM25 Training")
