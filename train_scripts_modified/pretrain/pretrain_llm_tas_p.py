"""
LLM-Enhanced TAS-Passage Training Script

This script integrates LLM-based hard negative classification into TAS-Passage pretraining
...
# Configuration
ENABLE_LLM = True  # Set to False for baseline TAS-Passage training
...
train_data = enhancer.enhance_training_data(train_data, method='TAS-Passage')

# Setting up the model arguments (SAME AS ORIGINAL)
...
# TAS-Passage specific settings
model_args.ance_training = False

# Setup model configuration paths using common LLM integration
base_output_dir = "../../trained_models/pretrained/TAS-P-msmarco"
base_wandb_name = "TAS-P-msmarco"
...
if __name__ == "__main__":
    ...
    print(f"🚀 Starting {'LLM-Enhanced' if enhancer.llm_available and ENABLE_LLM else 'Baseline'} TAS-Passage Training")
