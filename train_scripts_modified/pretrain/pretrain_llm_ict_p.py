"""
LLM-Enhanced ICT-Passage Training Script

This script integrates LLM-based hard negative classification into ICT-Passage pretraining
...
# Configuration
ENABLE_LLM = True  # Set to False for baseline ICT-Passage training
...
train_data = enhancer.enhance_training_data(train_data, method='ICT-Passage')
...
# ICT-Passage specific settings
model_args.ance_training = False

# Setup model configuration paths using common LLM integration
base_output_dir = "../../trained_models/pretrained/ICT-P-msmarco"
base_wandb_name = "ICT-P-msmarco"
...
if __name__ == "__main__":
    ...
    print(f"🚀 Starting {'LLM-Enhanced' if enhancer.llm_available and ENABLE_LLM else 'Baseline'} ICT-Passage Training")
