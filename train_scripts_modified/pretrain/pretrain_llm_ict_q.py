"""
LLM-Enhanced ICT-Query Training Script

This script integrates LLM-based hard negative classification into ICT-Query pretraining
...
# Configuration
ENABLE_LLM = True  # Set to False for baseline ICT-Query training
...
train_data = enhancer.enhance_training_data(train_data, method='ICT-Query')
...
# ICT-Query specific settings
model_args.ance_training = False

# Setup model configuration paths using common LLM integration
base_output_dir = "../../trained_models/pretrained/ICT-Q-msmarco"
base_wandb_name = "ICT-Q-msmarco"
...
if __name__ == "__main__":
    ...
    print(f"🚀 Starting {'LLM-Enhanced' if enhancer.llm_available and ENABLE_LLM else 'Baseline'} ICT-Query Training")
